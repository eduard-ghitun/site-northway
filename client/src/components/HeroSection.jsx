...
export default function HeroSection() {
  return (
    <section className="relative flex min-h-[100svh] items-center overflow-hidden pt-20 pb-10 sm:pt-24 sm:pb-14 lg:pt-24 lg:pb-10">
      <div className="container-shell grid items-center gap-6 sm:gap-8 lg:grid-cols-[minmax(0,0.68fr)_minmax(0,1.04fr)] lg:gap-16 xl:grid-cols-[minmax(0,0.64fr)_minmax(0,1.08fr)] xl:gap-24">
        <div className="relative z-10 mx-auto max-w-[34rem] text-center lg:-translate-y-8 lg:mx-0 lg:pr-4 lg:text-left xl:max-w-[31rem] xl:pr-8">
          ...
          >
            ...
            <h1 className="mx-auto max-w-[11ch] font-display text-[clamp(2rem,10vw,4.2rem)] uppercase leading-[0.92] tracking-[0.05em] text-white sm:max-w-[12ch] sm:tracking-[0.08em] lg:mx-0 lg:max-w-none lg:text-[3.75rem] xl:text-[4.2rem]">
              {heroContent.title}
            </h1>
            <p className="mx-auto mt-4 max-w-[28rem] text-[clamp(1.05rem,4.6vw,1.5rem)] font-semibold uppercase leading-[1.35] tracking-[0.08em] text-gold sm:mt-5 sm:tracking-[0.12em] lg:mx-0 lg:mt-6 lg:max-w-xl">
