        ...
        >
          {useLiteMotion ? (
            <>
              <motion.div
                ...
                className="absolute inset-0 bg-[linear-gradient(180deg,rgba(2,2,2,0.94)_0%,rgba(9,9,9,0.98)_100%)]"
              />
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(245,196,0,0.08),transparent_42%)]" />
            </>
          ) : (
            <>
              <motion.div
              ...
              >
                ...
                {!isMobileViewport ? <PanelWord word="NORTH" side="left" /> : null}
              ...
              >
                ...
                {!isMobileViewport ? <PanelWord word="SIDE" side="right" /> : null}
          ...
          <div className="relative z-10 flex h-full items-center justify-center px-6 text-center">
            <motion.p
              ...
              transition={{ duration: useLiteMotion ? 0.14 : 0.2, delay: useLiteMotion ? 0 : 0.06, ease: easing }}
              className="mt-5 text-[0.62rem] font-semibold uppercase tracking-[0.32em] text-white/40 sm:tracking-[0.38em]"
            >
              NorthSideCrew
            </motion.p>
          </div>
